# -*- mode: snippet -*-
# name: Begin Grouped Packages Adoption
# key: begin/groupedPackagesAdoption
# group: begin
# type: command
# --
(let* (
...
")
 ...
 (insert "   ;;; Installation Material Comes Here\n")
 (b:yas-expand-snippet|file (expand-file-name "pkgInstall:dblock.yas" $fileElements))
 (insert "   )\n")
 (b:insert:newLines|nuOf 1)
